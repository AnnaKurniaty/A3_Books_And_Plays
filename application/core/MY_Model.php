...
class MY_Model extends CI_Model{
	...
	function get_all($order_by = "id"or"id_jadwal", $ordered = "DESC", $limit = NULL, $offset = NULL){
		if($limit == NULL){
	...
	function get_filtered($filter, $order_by="id"or"nis"or"id_kelas"or"id_jurusan"or"id_user"or"id_wakel", $ordered="DESC", $limit=NULL, $offset=NULL){
		if($limit == NULL){
			$this->db->order_by($order_by, $ordered);
