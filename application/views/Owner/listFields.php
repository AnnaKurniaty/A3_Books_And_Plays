          ...
          <div class="row">
            <div class="col-md-12">
              <div class="section-title">
                <h5>List My Fields</h5>
                  <a href="<?php echo base_url(); ?>index.php/C_owner/addField/<?php echo $_SESSION['ID']; ?>">
                  <button class="btn-sm btn-primary" style="border: none;">Tambah Field</button>
                  </a>
                <hr>
              </div>
            </div>
